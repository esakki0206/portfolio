...
export const allSkills = [
  {
    ...
    proficiency: 82,
    recentActivity: 90,
    experience: '1+ year hands-on — production internship at FrontierWox Tech Pvt. Ltd. building real-world applications',
    icon: 'Atom',
    color: 'from-blue-500 to-cyan-400',
    description:
      'Core frontend technology used to build the Resume Builder web app during internship at FrontierWox Tech Pvt. Ltd. Proficient in functional components, custom hooks, context API, and React Router for SPA navigation. Applied component-driven architecture, lazy loading, and optimised re-renders with React.memo and useMemo for production performance.',
    certifications: [],
    projects: [
      'Resume Builder — Full-stack web app (FrontierWox Tech Pvt. Ltd. internship)',
  ...
  },
  {
    ...
    proficiency: 70,
    recentActivity: 80,
    experience: '6+ months — backend API development during production internship at FrontierWox Tech Pvt. Ltd.',
    icon: 'Server',
...
export const skillProgressData = {
  react: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 82 },
  ],
  javascript: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 78 },
  ],
  php: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 70 },
  ],
  mysql: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 72 },
  ],
  git: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 75 },
  ],
  python: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 80 },
  ],
  tensorflow: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 65 },
  ],
  arduino: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 60 },
  ],
  algorithms: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 55 },
  ],
  'react-native': [
  ...
  kotlin: [
    ...
    { label: 'Current proficiency', date: 'Jun 2026', value: 45 },
  ],
};
